...
export const generatedRoutes: GeneratedRoute[] = [
    ...
    children: [
      {
        name: 'blog_about',
        path: '/blog/about',
        component: 'view.blog_about',
        meta: {
          title: '关于本人',
          i18nKey: 'route.blog_about'
        }
      },
      {
        name: 'blog_albums',
        path: '/blog/albums',
        component: 'view.blog_albums',
        meta: {
          title: '相册管理',
          i18nKey: 'route.blog_albums'
        }
      },
      {
        name: 'blog_bangumis',
        path: '/blog/bangumis',
        component: 'view.blog_bangumis',
        meta: {
          title: '追番管理',
          i18nKey: 'route.blog_bangumis'
        }
      },
      {
        name: 'blog_categories',
        path: '/blog/categories',
        component: 'view.blog_categories',
        meta: {
          title: '分类管理',
          i18nKey: 'route.blog_categories'
        }
      },
      {
        name: 'blog_collections',
        path: '/blog/collections',
        component: 'view.blog_collections',
        meta: {
          title: '收藏管理',
          i18nKey: 'route.blog_collections'
        }
      },
      {
        name: 'blog_comments',
        path: '/blog/comments',
        component: 'view.blog_comments',
        meta: {
          title: 'blog_comments',
          i18nKey: 'route.blog_comments'
        }
      },
      {
        name: 'blog_documents',
        path: '/blog/documents',
        component: 'view.blog_documents',
        meta: {
          title: '文档管理',
          i18nKey: 'route.blog_documents'
        }
      },
      {
        name: 'blog_essays',
        path: '/blog/essays',
        component: 'view.blog_essays',
        meta: {
          title: '即刻短文',
          i18nKey: 'route.blog_essays'
        }
      },
      {
        name: 'blog_links',
        path: '/blog/links',
        component: 'view.blog_links',
        meta: {
          title: '友链管理',
          i18nKey: 'route.blog_links'
        }
      },
      {
        name: 'blog_menus',
        path: '/blog/menus',
        component: 'view.blog_menus',
        meta: {
          title: '菜单管理',
          i18nKey: 'route.blog_menus'
        }
      },
      {
        name: 'blog_moments',
        path: '/blog/moments',
        component: 'view.blog_moments',
        meta: {
          title: '即刻短文',
          hideInMenu: true,
          i18nKey: 'route.blog_moments'
        }
      },
      {
        name: 'blog_music',
        path: '/blog/music',
        component: 'view.blog_music',
        meta: {
          title: '音乐管理',
          i18nKey: 'route.blog_music'
        }
      },
      {
        name: 'blog_site',
        path: '/blog/site',
        component: 'view.blog_site',
        meta: {
          title: '站点管理',
          i18nKey: 'route.blog_site'
        }
      },
      {
        name: 'blog_tags',
        path: '/blog/tags',
        component: 'view.blog_tags',
        meta: {
          title: '标签管理',
          i18nKey: 'route.blog_tags'
        }
      }
    ]
  },
  ...
  {
    name: 'login',
    path: '/login/:module(pwd-login|code-login|register|reset-pwd|bind-wechat|github-login)?',
