const local: App.I18n.Schema = {
  ...
  route: {
    ...
    home: 'Home',
    document: 'Document',
    'document_project-link': 'Soybean Admin(External Link)',
    document_vue: 'Vue Document',
    document_vite: 'Vite Document',
    document_unocss: 'UnoCSS Document',
    document_naive: 'Naive UI Document',
    'document_nest-admin': 'Nest Admin',
    'document_nest-admin-link': 'Nest Admin(External Link)',
    blog: 'Blog management',
    blog_site: 'Site',
    blog_menus: 'Menus',
    blog_documents: 'Documents',
    blog_categories: 'Categories',
    blog_tags: 'Tags',
    blog_albums: 'Albums',
    blog_bangumis: 'Bangumis',
    blog_about: 'About',
    blog_essays: 'Essays',
    blog_links: 'Links',
    blog_moments: 'Moments',
    blog_comments: 'Comments',
    blog_collections: 'Collections',
    blog_music: 'Music',
    ...
    tools_storage_local: 'File Management',
