...
export const views: Record<LastLevelRouteKey, RouteComponent | (() => Promise<RouteComponent>)> = {
  ...
  blog_about: () => import("@/views/blog/about/index.vue"),
  blog_albums: () => import("@/views/blog/albums/index.vue"),
  blog_bangumis: () => import("@/views/blog/bangumis/index.vue"),
  blog_categories: () => import("@/views/blog/categories/index.vue"),
  blog_collections: () => import("@/views/blog/collections/index.vue"),
  blog_comments: () => import("@/views/blog/comments/index.vue"),
  blog_documents: () => import("@/views/blog/documents/index.vue"),
  blog_essays: () => import("@/views/blog/essays/index.vue"),
  blog_links: () => import("@/views/blog/links/index.vue"),
  blog_menus: () => import("@/views/blog/menus/index.vue"),
  blog_moments: () => import("@/views/blog/moments/index.vue"),
  blog_music: () => import("@/views/blog/music/index.vue"),
  blog_site: () => import("@/views/blog/site/index.vue"),
  blog_tags: () => import("@/views/blog/tags/index.vue"),
