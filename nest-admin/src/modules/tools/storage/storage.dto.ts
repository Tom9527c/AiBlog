...
import { ArrayNotEmpty, ArrayMaxSize, IsInt, IsIn, IsArray, IsOptional, IsString, Min } from 'class-validator';

import { PagerDto } from '~/common/dto/pager.dto';

export class StoragePageDto extends PagerDto {
  @IsOptional() @IsIn(['general', 'blog']) source?: string;
  @IsOptional() @IsIn(['local', 'aliyun', 'qcloud']) provider?: string;
